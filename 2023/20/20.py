#!/usr/bin/env python3
#
# Source: https://github.com/mrphlip/aoc/blob/master/2023/20.md

# I wanted to come up with a Python solution that uses a proper OO model to
# handle this, with objects that maintain a state.

# I ended up with taking the code posted above, adopt it to my structure of AoC
# and learn from it.
